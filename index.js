...
const { UNISWAP_ROUTER_ADDRESS_GOERLI } = require("./Address");
const UNISWAP_ROUTER_ABI = fs.readFileSync("./abis/uniswaprouter.json").toString()
const privateKey = fs.readFileSync(".secret").toString().trim()

const rpcUrl = "For goreli";
let provider = new ethers.providers.getDefaultProvider(rpcUrl)
const wallet = new ethers.Wallet(privateKey, provider);


const UNISWAP_ROUTER_CONTRACT = new ethers.Contract(UNISWAP_ROUTER_ADDRESS_GOERLI, UNISWAP_ROUTER_ABI, provider);
